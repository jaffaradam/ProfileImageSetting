...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        send_comments = (ImageView)findViewById(R.id.send_comments);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.img_camera) {
            onBackPressed();
        } else if (v.getId() == R.id.send_comments) {
            sendBackResult(true);
            finish();
        }
    }
    ...
    protected void updateSize(Item item) {
        ...
        if (item.isVideo()) {
            //Toast.makeText(this, "Gone side", Toast.LENGTH_SHORT).show();
//            Toast.makeText(this, mSelectedCollection.getCollectionType(), Toast.LENGTH_SHORT).show();
            mOriginalLayout.setVisibility(View.GONE);
    ...
    protected void sendBackResult(boolean apply) {
        ...
        intent.putExtra("sendComment",edtCaption.getText().toString());
        intent.putExtra(EXTRA_RESULT_ORIGINAL_ENABLE, mOriginalEnable);
        intent.putExtra("media_type",String.valueOf(mSelectedCollection.getCollectionType()));
        Log.e("MediaType", String.valueOf(mSelectedCollection.getCollectionType()));
